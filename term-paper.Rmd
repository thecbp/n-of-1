...
fig2cap = "Adina this is all you guuuuuurl"

fig3cap = "Simulations showding how varying treatment parameters affects power, treatment effect estimation and PCS."
```
...
From Figure 2, the treatment order $ABBA$ has the closest estimate of treatment effect with a median of -2.43 and variance of 0.21. The differences in treatment effect are likely a result of the carryover and run-in effects. Given that our simulation assumed 5 day periods and sampled once a period, carryover and run-in effects become prominent.
