...
model.outcome = function(bb, 
  ...
  # To-do:
  # - sum all effects to get an observed effect
  # - add this observed effect into the 
  # - start with continuous outcome first
  ...
  # Add in a baseline value
  bb = bb %>% 
    mutate(
      baseline = rnorm(nrow(bb), mu.b, sd.b)
    )
  
  # Create simple treatment effect for all the given treatments
